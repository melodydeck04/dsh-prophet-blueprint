...
import { applyFeatureIdentityMigration, applyArchitectureChange, deriveFeatureId, prepareFeatureArtifacts, previewFeatureIdentityMigration, previewArchitectureChange, resolveFeatureArtifacts } from "./artifacts.js";
...
export async function handleBlueprintAction(input) {
	...
	throw new BlueprintApiError(400, "UNKNOWN_ACTION", "action must be dashboard, discover, initialize, upgrade, approve, prepare, migration-preview, migration-apply, architecture-preview, architecture-apply, or save");
}

...
async function main() {
	...
	if (parsed.command !== "docs" && parsed.command !== "approve" && parsed.command !== "verification" && parsed.positional.length > 0) throw new Error(`unexpected positional arguments: ${parsed.positional.join(" ")}`);
